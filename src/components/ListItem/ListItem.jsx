...
const ListItem = (props) => {
  ...
  return (
    <div className="catalog__content--item">
      <div className='catalog__content--item--imageContainer'>
        <img src={props.url} alt="" />
        <Link to={`/product/${props.name.toLowerCase()}`}>
          <button className="catalog--preview">
      ...
      <p id="product__price"> ${props.price.toLocaleString()}</p>
      <p className="catalog--quanity-text"> {quantity} </p>
